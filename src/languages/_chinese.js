export default {
  ...
  borrow_landing: {
    ...
    feature2_content:
      '一键式交互页面，无中心化和第三方控制资产。',
    feature3_heading: '多样的选择',
    feature3_content:
      '管理不同类型的抵押品「金库」，所有记录透明可查。',
  ...
  borrow_wbtc_landing: {
    ...
    step3_details:
      "通过 CoinList 的服务，将 BTC 转换成以太坊网络上的 wBTC。 ",
  ...
  action_sidebar: {
    ...
    generate_title: '生成 USDL',
    generate_description: '你希望生成多少 USDL?',
    generate_warning:
      '你生成的 Dai 的数量会让金额接近清算线风险',
    generate_threshold: '尝试生成的 Dai 超过了可授权的数额，请输入少于 {0} 的 Dai 数额。',
    payback_title: '偿还 USDL',
    payback_description: '你希望偿还多少 USDL?',
  ...
  transactions: {
    ...
    creating_cdp: '创建金库',
    generate_dai: '生成 USDL',
    pay_back_dai: '偿还 USDL',
