export default {
  ...
  landing_page: {
    ...
    banner_bridge: 'From now you can transfer your FL tokens beetween ETH and BSC networks',
    ...
    banner_swop_text: 'Add to FL-USDN liquidity on {0} and earn {1} farming rewards!',
    title: 'Freeliquid',
    ...
    rd_b2_3: 'Adoption Freeliquid DAO smart-contracts on Binance Smart Chain',
    rd_b2_4: 'Integration with Pancakeswap stable pools',
    rd_b2_5: ' - Supports of Pancake LP tokens (BUSD/DAI, BUSD/USDT, BUSD/USDC) for borrow USDFL',
    rd_b2_6: 'Integration with Multichain bridge for swap FL governance token to BSC',
    rd_b3_1: 'FL and USDFL  listing in liquidity pools of different platforms on BSC (providing USDFL liquidity)',
    rd_b3_2: 'Ellipsis.finance integration',
    rd_b3_3: 'Preparation of new collateral pairs and optimization of the working interface of the website',
    rd_b3_1_1: '',
